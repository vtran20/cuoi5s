...
<%--<c:if test="${fn:contains('/site/billing.html', uri)}"><c:set var="payBill" value="active"/></c:if>--%>
<div class="col-md-3">
    <ul class="list-group sidebar-nav-v1" id="sidebar-nav">
        ...
        <%--<li class="list-group-item ${payBill}"><a href="/site/billing.html"><fmt:message key="site.billing.pay"/></a></li>--%>
