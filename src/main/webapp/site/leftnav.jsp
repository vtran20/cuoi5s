...
<c:if test="${uri == '/site/main.html'}"><c:set var="main" value="active"/></c:if>
...
<div class="col-md-3">
    <ul class="list-group sidebar-nav-v1" id="sidebar-nav">
        <%--<li class="list-group-item ${main}"><a href="/site/main.html"><fmt:message key="site.regiester.select.template"/></a></li>--%>
