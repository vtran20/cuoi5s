...
<%--<app:cache key="rewritten_uri:${uri}|${queryString}|page:discount.jsp">--%>

<html>
<head>
<title><fmt:message key="discount.page"/></title>
<meta name="description" content="<fmt:message key="discount.page"/>"/>
<meta name="keywords" content="<fmt:message key="discount.page"/>"/>
...
<%--This use for pagination--%>
    ...
    <spring:eval expression="serviceLocator.getSearchService().search('discount', command.categoryId, site, refinementMap, command.startPos, command.maxResult, command.sortField, command.reverse, true)" var="searchResult" />
...
<div id="thumbnail-height">
    ...
    <div class="cat-thu-pagnation">
        ...
        <h1><fmt:message key="discount.result"/></h1>
    ...
    <c:if test="${empty products}">
        <div class="cat-thu-pagnation">
            <div class="cat-glo-pagnation glo-form">
            <h1><fmt:message key="no.discount.product"/></h1>
