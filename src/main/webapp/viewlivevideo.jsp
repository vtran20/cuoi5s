...
<%--<app:cache key="${uri}">--%>
<c:set value="http://${site.domain}${uri}" var="videoUrl"/>
...
<head>
    ...
    <h:head/>
    <meta property="og:site_name" content="mangchiase.com">
    <meta property="og:url" content="${videoUrl}">
    <%--<meta property="og:title" content="<c:out value="${video.name}"/>">--%>
    <%--<meta property="og:image" content="${video.mediumImgUrl}">--%>
    <meta property="og:description" content="Share để mọi người cùng xem">
    <meta property="og:type" content="video">
    <meta property="og:video" content="http://www.youtube.com/v/${id}?autohide=1&amp;version=3">
        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="input-group">
                    <input type="text" name="query" id="query" class="form-control" placeholder="Nhập nội dung cần tìm: Manchester, The voice kids ...">
            ...
            <div class="blog margin-bottom-40">
                <div class="blog-img margin-bottom-20">
                    <div class="responsive-video" id="iframe-youtube">
                        <iframe id="ytplayer" type="text/html" src="http://www.youtube.com/embed/${id}?autoplay=1&showinfo=0&iv_load_policy=3&ps=docs&enablejsapi=1&version=3&wmode=transparent" frameborder="0"></iframe>
                    </div>
                </div>
