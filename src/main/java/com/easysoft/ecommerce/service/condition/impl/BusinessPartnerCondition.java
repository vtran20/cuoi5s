...
import com.easysoft.ecommerce.controller.SiteController;
...
/**
 * Expession: (PARTNER_TYPE==2 and PARTNER_STATUS=='Y')
 * 
 * User: Vu Tran
 * Date: Dec 19, 2010
 * Time: 3:13:11 PM
 ...
 */
public class BusinessPartnerCondition extends ConditionSupport implements Serializable {

    private static final Logger LOGGER = LoggerFactory.getLogger(BusinessPartnerCondition.class);
