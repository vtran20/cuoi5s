 ...
 */
public class ChuyenKhoanPayment extends PaymentSupport implements Serializable {

    private static final Logger LOGGER = LoggerFactory.getLogger(ChuyenKhoanPayment.class);
